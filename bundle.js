...
minixhr('https://api.github.com/users/djape48', startPage)
    ...
    return yo`
      <div>
        <div class="${css.textbox}">
          Ovo je moj prvi rad u JavaScript-u, tako da ima puno
          prostora za poboljšanje. "Svakoga dana, u svakom pogledu,
          sve vise napredujemo" :D
        </div>
      </div>
    `
  }
...
function footerComponent () {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/djape48">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
      <a href="mailto:djape48@gmail.com ">
        <i class="${css.icon} fa fa-envelope-o" aria-hidden="true"></i>
      </a>
      <a href="https://www.facebook.com/vasic.predrag.5">
